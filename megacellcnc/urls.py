...
urlpatterns = [
    ...
    path('update-battery-name/',megacellcnc_views.update_battery_name,name="update-battery-name"),
    ...
    path('restore-backup/', megacellcnc_views.restore_backup, name='restore-backup'),
    path('list-server-backups/', megacellcnc_views.list_server_backups, name='list-server-backups'),
    path('delete-server-backups/', megacellcnc_views.delete_server_backups, name='delete-server-backups'),
    path('download-server-backup/', megacellcnc_views.download_server_backup, name='download-server-backup'),
    path('restore-server-backup/', megacellcnc_views.restore_server_backup, name='restore-server-backup'),
    path('backup-journal/', megacellcnc_views.backup_journal_list, name='backup-journal'),
    path('system/migration-status/', megacellcnc_views.migration_status, name='migration-status'),
    path('system/migration-run/', megacellcnc_views.run_migrations_ui, name='migration-run'),
    ...
    path('get-cell-id-by-uuid/', megacellcnc_views.get_cell_id_by_uuid, name='get-cell-id-by-uuid'),
